...
const (
	...
	MsgVersionCatalogFound           = "Version Catalog detected (gradle/libs.versions.toml)."
	MsgVersionCatalogMissing         = "Version Catalog not found. Falling back to direct dependency."
	MsgVersionCatalogClixAliasAdded  = "Added Clix alias to Version Catalog."
	MsgVersionCatalogClixAliasExists = "Clix alias already present in Version Catalog."
	MsgVersionCatalogClixAliasFailed = "Failed to update Version Catalog with Clix alias."
